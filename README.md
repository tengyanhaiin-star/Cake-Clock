...
Simply open the [3D Cake Clock](https://tengyanhaiin-star.github.io/Cake-Clock/) in any modern browser. No build tools or dependencies required — Three.js is loaded from a CDN.
